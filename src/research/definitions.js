...
const ResearchDefinitions=(()=>{
  ...
  const data={revision:1,categories:['production','weapons','drones'],
    ...
    research:[
      {id:'research.station_fabrication',category:'production',title:'research.project.fabrication',description:'research.description.fabrication',effect:'research.effect.fabrication',cost:12,blueprints:[],requires:yes('base.core_powered'),technologies:['technology.station_fabrication'],requirementLabel:'research.require.core',icon:{kind:'buildable',id:'craft_bench'}},
      {id:'research.precision_weapons',category:'weapons',title:'research.project.precision',description:'research.description.precision',effect:'research.effect.precision',cost:18,blueprints:['blueprint.precision_weapons'],requires:yes('base.core_powered'),technologies:['technology.precision_weapons'],requirementLabel:'research.require.core',icon:{kind:'item',id:'rifle_m4'}},
      {id:'research.scout_service',category:'drones',title:'research.project.scout',description:'research.description.scout',effect:'research.effect.scout',cost:15,blueprints:['blueprint.scout_service'],requires:yes('base.drone_station','research.error.drone_station'),technologies:['technology.scout_service'],requirementLabel:'research.require.drone',icon:{kind:'item',id:'drone014'}},
      {id:'research.workshop_efficiency',category:'production',title:'research.project.efficiency',description:'research.description.efficiency',effect:'research.effect.efficiency',cost:15,blueprints:[],requires:yes('base.core_powered'),technologies:['technology.workshop_efficiency'],requirementLabel:'research.require.core',icon:{kind:'buildable',id:'utility_workbench'}}
    ],
