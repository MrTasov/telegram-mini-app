...
window.V010Inventory=(()=>{
  ...
  function details(where,index){
    ...
    const names={repairPercent:'Ремонт за удар, %',armor:'Защита',hp:'HP',health:'HP',maxHealth:'Макс. HP',speed:'Скорость',damage:'Урон',spread:'Разброс',accuracy:'Точность',magazine:'Магазин',capacity:'Мест',mag:'Магазин',reloadMs:'Перезарядка',recoil:'Отдача',delay:'Интервал выстрела'};
