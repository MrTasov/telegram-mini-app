...
window.CampaignDefinitions=(()=>{
  const definitions={revision:3,first:'base_check',facts:['generatorRunning','corePowered','mined','woodStored','ironProduced','batteryCharge','perimeterCondition','copperProduced','medicalStored','droneReady','workshopLit'],
    chapters:[
      {id:'base_check',title:'campaign.chapter.check',description:'campaign.chapter.check.description',goal:'core.chapter.check.goal',requires:[],next:'free_preparation',objectives:[
        ...
        {id:'copper_after',since:3,title:'campaign.objective.copper',description:'campaign.objective.copper.description',required:false,semantics:'after',requires:['iron_after'],condition:{fact:'copperProduced',atLeast:2}},
        {id:'medical_stock',since:3,title:'campaign.objective.medical',description:'campaign.objective.medical.description',required:false,semantics:'current',requires:[],condition:{fact:'medicalStored',atLeast:3}},
        {id:'drone_once',since:3,title:'campaign.objective.drone',description:'campaign.objective.drone.description',required:false,semantics:'once',requires:['power_once'],condition:{fact:'droneReady',equals:true}},
        {id:'workshop_light',since:3,title:'campaign.objective.light',description:'campaign.objective.light.description',required:false,semantics:'current',requires:[],condition:{fact:'workshopLit',equals:true}}
      ]},
      {id:'free_preparation',title:'campaign.chapter.free',description:'campaign.chapter.free.description',goal:'core.chapter.free.goal',requires:['base_check'],next:null,objectives:[]}
    ]};
