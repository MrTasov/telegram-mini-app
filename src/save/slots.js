...
GameSave.extend('decode','save.slots',function(v09OriginalDecode,raw){
  ...
  if(!legacy&&(d.schema!==2||!/^0\.(?:9(?:\.\d+)?|(?:10\.[012345]|11\.[01]|12\.[01]|13\.0|14\.[0123]|15\.[012]|16\.[0123]|17\.0|18\.0|(?:19\.[01]|20\.0|21\.0|22\.0|23\.[01]|24\.[01]|25\.[0123]|26\.0|27\.[01]|28\.0|29\.0|30\.[01]|31\.[01]|32\.[01])))$/.test(d.gameVersion||'')))
...
function v09DownloadSave(){
  try{
    ...
    a.download=`survival-base-0.32.1-${filename}-${new Date().toISOString().slice(0,10)}.json`;
