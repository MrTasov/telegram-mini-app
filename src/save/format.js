...
const SaveFormat=(()=>{
  const VERSION=3,MAX_BYTES=2*1024*1024;
  const migrations=[{from:0,to:1,id:'explicit-envelope-version',apply(d){d.saveVersion=1;return d;}},{from:1,to:2,id:'stable-actor-and-enemy-identities',apply(d){d.saveVersion=2;return d;},complete(d){GameIdentity.migrate(d);}},{from:2,to:3,id:'world-farm-resources',apply(d){GameLivestock.migrate(d);d.saveVersion=3;return d;}}];
  ...
  function stamp(data){data.saveVersion=VERSION;data.gameVersion='0.28.0';return data;}
