...
window.V0161UI=(()=>{
  ...
  const controls=['v033LightToggle','v010Minimap','moveControl','aimControl','actionButton','bagButton','settingsButton','hotbar','v010SneakButton','v010ReloadButton','v014DroneHUD','v091JumpInward','v014RouteStop','v010PracticeStop','v010PinnedRecipe','v010PinnedGoal','searchBarWrap','v016Placement','v163Vitals','heldItemName'];
  let serial=15000,dismissGesture=null,pointerGesture=null;
  function sync(){const open=!!document.querySelector('.overlay.open');menuOpen=open||playerDead||!!window.MainMenu?.active;if(document.body.classList.contains('v0161Modal')!==menuOpen)document.body.classList.toggle('v0161Modal',menuOpen);window.GameHeadModules?.refresh();}
  function opened(o){
