...
exports.project=value=>{
 const d=JSON.parse(JSON.stringify(value));delete d.placement035;delete d.research036;delete d.story037;delete d.sectors038;delete d.carry0353;delete d.control0353;
