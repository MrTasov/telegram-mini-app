...
const runtimeSha256=require('node:crypto').createHash('sha256').update(fs.readFileSync('js/game.js')).digest('hex');
 ...
 for(const [width,height,mode,sceneName]of [[390,844,'MOBILE','bunker_hall'],[1280,800,'PC','bunker_moving_lights'],[1280,800,'PC','bunker_door_spill']]){
