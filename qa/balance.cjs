...
actual.save.topKeys=actual.save.topKeys.filter(k=>k!=='saveVersion'&&k!=='identity027'&&k!=='bunker030'&&k!=='campaign031'&&k!=='equipment032'&&k!=='headModules033'&&k!=='recovery033'&&k!=='chapter034');
delete actual.save.schemas.identity027;delete actual.save.schemas.bunker030;delete actual.save.schemas.campaign031;delete actual.save.schemas.equipment032;delete actual.save.schemas.headModules033;delete actual.save.schemas.recovery033;delete actual.save.schemas.chapter034;actual.save.schemas.gathering=expected.save.schemas.gathering;
