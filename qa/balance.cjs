...
const version=actual.version;actual.version=expected.version; // Only release metadata differs.
...
const report={version,passed:error?0:1,failed:error?1:0,scope:'All Stage 0 item/weapon/enemy/upgrade/drone/power/wall/farm configuration samples; only gameVersion normalized.',error,consoleErrors:r.errors};
