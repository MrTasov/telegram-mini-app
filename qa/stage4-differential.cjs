// Behavioral oracle: execute the accepted 0.23.1 and the candidate with identical
...
// Exhaustive existing variants/specializations/levels, compared to executable 0.23.1.
