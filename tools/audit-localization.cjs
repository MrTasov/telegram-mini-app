...
const baselineFiles=[...old.baselineFiles,...['stage4-fixed','stage5-accepted'].map(dir=>['index.html','js/game.js','js/game.js.map','styles/base.css'].map(f=>({file:'qa/'+dir+'/'+f,sha256:hash(fs.readFileSync('qa/'+dir+'/'+f))}))).flat()];
