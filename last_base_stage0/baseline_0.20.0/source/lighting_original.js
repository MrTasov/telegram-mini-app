window.V016Lighting=(()=>{
  ...
  function fixtures(){
    ...
    for(const o of base.sections)if(o.group==='outer'&&Number(o.id.split('_').at(-1))%2===1){
      const nx=o.side==='W'?1:o.side==='E'?-1:0,ny=o.side==='N'?1:o.side==='S'?-1:0;
      a.push({id:'lamp016_'+o.id,kind:'wall',wall:o,x:o.x+o.w/2+nx*(o.w/2+4),y:o.y+o.h/2+ny*(o.h/2+4),height:3.8,angle:Math.atan2(ny,nx),range:330,device:o.x+o.w/2<800?'spot_left':'spot_right'});
    }
    ...
    const corners=[['NW',194,126,-Math.PI/2,'v091wall015_NL_0'],['NW',166,154,Math.PI,'v091wall015_NL_0'],['NE',1406,126,-Math.PI/2,'v091wall015_NR_3'],['NE',1434,154,0,'v091wall015_NR_3'],['SW',194,1074,Math.PI/2,'v091wall015_SL_0'],['SW',166,1046,Math.PI,'v091wall015_SL_0'],['SE',1406,1074,Math.PI/2,'v091wall015_SR_3'],['SE',1434,1046,0,'v091wall015_SR_3']];
