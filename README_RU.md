> Актуальный патч: **walk-soft-steps-1** — цикл спрайтовой ходьбы ×3, мягкие шаги с громкостью канала ×0,5. Скорость движения и gameplay сохранены. [Отчёт](WALK_SOFT_STEPS_RU.md).
...
3. Обновите страницу после загрузки всех файлов. Cache-tag JavaScript — `0.29.0-walk-soft-steps-1`.
